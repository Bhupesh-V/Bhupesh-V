...
<ul><li><a href="https://bhupesh.gitbook.io/notes/shell/grep-cheatsheet">grep cheatsheet</a></li><li><a href="https://bhupesh.gitbook.io/notes/shell/writing-simple-file-watcher">Writing a simple file watcher using GNU Utils</a></li><li><a href="https://bhupesh.gitbook.io/notes/git/view-python-function-git-history-with-fzf">View a python function's history over-time with Git & FZF</a></li><li><a href="https://bhupesh.gitbook.io/notes/python/flatten-python-list">Easy & Lazy way to flatten a python list</a></li></ul></td></tr></table></details>
...
<details open><summary><b>How many different console applications does one need in his OS? Windows:</b></summary>

<table>
<tr>
<th valign="top" width="50%">
<img title="Memes here update every 24hrs, come back tommorrow for new meme ;)" alt="How many different console applications does one need in his OS? Windows:" src="https://i.redd.it/9igbs6249d681.png" height="50%"><br>
<p><strong>ℹ️ <a href="https://www.reddit.com/r/ProgrammerHumor/comments/rjgnj2/how_many_different_console_applications_does_one/">Source</a> [ Powered By 🔥 <a href="https://github.com/Bhupesh-V/memer-action">Memer Action</a> ]</strong></p>
</th>
</tr>
</table>
</details>
