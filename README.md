...
<ul><li><a href="https://til.bhupesh.me/aws/ecr-ecs">AWS Elastic Container Registry & Elastic Container Service</a></li><li><a href="https://til.bhupesh.me/git/using-multiple-git-accounts-with-git-credentials">Using multiple git user configs with credentials store (multiple github accounts)</a></li><li><a href="https://til.bhupesh.me/go/concurrency-difference-go-vs-elixir">Concurrency Comparison: Go v/s Elixir</a></li><li><a href="https://til.bhupesh.me/shell/changing-display-configuration-using-xrandr">Changing Display Configuration using xrandr</a></li></ul></td><td valign="top" width="33%"><b>Newsletter</b>
...
<details open><summary><b>A new time zone for the time zone devs to play with</b></summary>

<table>
<tr>
<th valign="top" width="50%">
<img title="Memes here update every 24hrs, come back tommorrow for new meme ;)" alt="A new time zone for the time zone devs to play with" src="https://i.redd.it/dwam1dusbeqa1.jpg" height="50%"><br>
<p><strong>ℹ️ <a href="https://www.reddit.com/r/ProgrammerHumor/comments/1242ckh/a_new_time_zone_for_the_time_zone_devs_to_play/">Source</a> [ Powered By 🔥 <a href="https://github.com/Bhupesh-V/memer-action">Memer Action</a> ]</strong></p>
</th>
</tr>
</table>
</details>
