...
<details open><summary><b>{{aTitleStart}}Title{{aTitleEnd}}</b></summary>

<table>
<tr>
<th valign="top" width="50%">
<img title="Memes here update every 69th minute, come back again for new memes ;)" alt="{{aTitleStart}}Title{{aTitleEnd}}" src="https://i.redd.it/k5v6i6wq0pd61.jpg" height="50%"><br>
<p><strong>ℹ️ <a href="https://www.reddit.com/r/ProgrammerHumor/comments/l5fxw8/atitlestarttitleatitleend/">Source</a> [ Powered By 🔥 <a href="https://github.com/Bhupesh-V/memer-action">Memer Action</a> ]</strong></p>
</th>
</tr>
</table>
</details>
