...
<ul><li><a href="https://bhupesh.gitbook.io/notes/python/everything-about-date-and-time-in-python">Everything about date & time in python</a></li><li><a href="https://bhupesh.gitbook.io/notes/git/get-list-of-all-branches">Get list of all branches</a></li><li><a href="https://bhupesh.gitbook.io/notes/shell/fzf-tips-tricks">FZF: Tips and Tricks</a></li><li><a href="https://bhupesh.gitbook.io/notes/python/dividing-time-deltas-python">Dividing Time deltas in python - Difference b/w 2 datetime values</a></li></ul></td></tr></table></details>

### Today's Meme ٩(^‿^)۶

<details open><summary><b>When you make a forward propagation to your neural network</b></summary>

<table>
<tr>
<th valign="top" width="50%">
<img title="Memes here update every 69th minute, come back again for new memes ;)" alt="When you make a forward propagation to your neural network" src="https://i.redd.it/3aa7wi2467r61.gif" height="50%"><br>
<p><strong>ℹ️ <a href="https://www.reddit.com/r/ProgrammerHumor/comments/mk1h6r/when_you_make_a_forward_propagation_to_your/">Source</a> [ Powered By 🔥 <a href="https://github.com/Bhupesh-V/memer-action">Memer Action</a> ]</strong></p>
</th>
</tr>
</table>
</details>
