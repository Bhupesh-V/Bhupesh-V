...
<ul><li><a href="https://til.bhupesh.me/data warehouse/why-reverse-ctl">Why Reverse ETL</a></li><li><a href="https://til.bhupesh.me/startups/pitchdeck-resources">Pitchdeck Resources</a></li><li><a href="https://til.bhupesh.me/aws/ecr-ecs">AWS Elastic Container Registry & Elastic Container Service</a></li><li><a href="https://til.bhupesh.me/git/using-multiple-git-accounts-with-git-credentials">Using multiple git user configs with credentials store (multiple github accounts)</a></li></ul></td><td valign="top" width="33%"><b>Newsletter</b>
...
<details open><summary><b>Language doesnt matter, it always ends up like this.</b></summary>

<table>
<tr>
<th valign="top" width="50%">
<img title="Memes here update every 24hrs, come back tommorrow for new meme ;)" alt="Language doesnt matter, it always ends up like this." src="https://i.redd.it/9x8kzuc4n8sa1.png" height="50%"><br>
<p><strong>ℹ️ <a href="https://www.reddit.com/r/ProgrammerHumor/comments/12dfaqu/language_doesnt_matter_it_always_ends_up_like_this/">Source</a> [ Powered By 🔥 <a href="https://github.com/Bhupesh-V/memer-action">Memer Action</a> ]</strong></p>
</th>
</tr>
</table>
</details>
