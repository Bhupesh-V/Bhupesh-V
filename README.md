...
<ul><li><a href="https://bhupesh.gitbook.io/notes/git/git-diff-since-last-git-pull">View git diff since the last git pull</a></li><li><a href="https://bhupesh.gitbook.io/notes/atabases/explain-postgresql-query">EXPLAIN queries in PostgreSQL</a></li><li><a href="https://bhupesh.gitbook.io/notes/shell/grep-cheatsheet">grep cheatsheet</a></li><li><a href="https://bhupesh.gitbook.io/notes/shell/writing-simple-file-watcher">Writing a simple file watcher using GNU Utils</a></li></ul></td></tr></table></details>
...
<details open><summary><b>A real men never needs a second query</b></summary>

<table>
<tr>
<th valign="top" width="50%">
<img title="Memes here update every 24hrs, come back tommorrow for new meme ;)" alt="A real men never needs a second query" src="https://i.redd.it/rwi9uqryto981.jpg" height="50%"><br>
<p><strong>ℹ️ <a href="https://www.reddit.com/r/ProgrammerHumor/comments/rvwpso/a_real_men_never_needs_a_second_query/">Source</a> [ Powered By 🔥 <a href="https://github.com/Bhupesh-V/memer-action">Memer Action</a> ]</strong></p>
</th>
</tr>
</table>
</details>
